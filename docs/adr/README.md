...
- [0001: Notifications for cross-view communication](0001-notifications-for-cross-view-comms.md)
- [0002: AttentionManager lives in App layer](0002-attention-manager-in-app-layer.md)
