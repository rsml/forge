...
(*.[0-9]*)
	...
	if test ! -f "/Users/ross/Personal/forge/.tmux-build/ncurses-6.4/man_alias.sed" ; then
cat >>/Users/ross/Personal/forge/.tmux-build/ncurses-6.4/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/ross/Personal/forge/.tmux-build/ncurses-6.4/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/Users/ross/Personal/forge/.tmux-build/ncurses-6.4/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/Users/ross/Personal/forge/.tmux-build/ncurses-6.4/man_alias.sed" \
		< "$i" >$TMP
